...
class LEDController:
    ...
    def __init__(self, port, baudrate):
        ...
        self.leds = {
            1: {'id': 1, 'название': 'SkvoziT', 'pin': 2, 'состояние': 'выкл'},
            2: {'id': 2, 'название': 'wol4ik91', 'pin': 3, 'состояние': 'выкл'},
            3: {'id': 3, 'название': 'СЫН_фанпей', 'pin': 4, 'состояние': 'выкл'},
            4: {'id': 4, 'название': 'Mastermind', 'pin': 5, 'состояние': 'выкл'},
            5: {'id': 5, 'название': 'Место свободно', 'pin': 6, 'состояние': 'выкл'},
            6: {'id': 6, 'название': 'Место свободно', 'pin': 7, 'состояние': 'выкл'},
            7: {'id': 7, 'название': 'Место свободно', 'pin': 8, 'состояние': 'выкл'},
            8: {'id': 8, 'название': 'Место свободно', 'pin': 9, 'состояние': 'выкл'},
            9: {'id': 9, 'название': 'Место свободно', 'pin': 10, 'состояние': 'выкл'},
            10: {'id': 10, 'название': 'Место свободно', 'pin': 11, 'состояние': 'выкл'},
            11: {'id': 11, 'название': 'Место свободно', 'pin': 12, 'состояние': 'выкл'},
            12: {'id': 12, 'название': 'Место свободно', 'pin': 13, 'состояние': 'выкл'},
        }
